...
Headline: Everyone has 17 agents working for them. You're behind!
Trendline: Most people are still using it for search and writing help.

Headline: The value of communities is declining.
Trendline: Asana generates $1M+ qualified pipeline via community.

Headline: All learning will happen through generative results.
Trendline: A Director, CustEd told me instructor-led is up 35% YoY

Headline: If it's not available via prompt window, it doesn't exist.
Trendline: A unicorn told me their local meetups are up 2.5x YoY.

Headline: Customers just want to talk to our chatbots!
Trendline: They do not (forcing them to is not causation).

Headline: Brian is old and busted
Trendline: Brian is experienced and wise

There will be no debate on that last one, as the data is proprietary.
...
### Post 2
---
Tiffany Oda just presented this slide about the business impact of the Asana Community at Gainsight Pulse.
...
1. Google, OpenAI, & Anthropic scraped your content
2. Users are consuming it via genAI results
3. We have limited visibility into where/when/how many
4. Leadership only sees the bad half of the story
5. Bad things happen

It's only a matter of time until AI companies productize analytics tools and we'll have a better understanding of reality. openfound.ai is the first such third party tool that I've seen.
...
### Post 4
---
The best Advocacy programs are small, exclusive, and insanely valuable.
...
Getting it right ignites impact across all three phases of the game: land, expand, and retain.


### Post 5
---
Most of the advice about GEO/AEO is B.S.

Source: Google

They just published a lengthy guide that is best summarized as "Nothing has changed. Keep doing the same stuff you were doing for SEO. AI will figure it out."

My strategic recommendations:
1. Ignore the "experts" telling you to refactor everything
2. Double-down on trusted, authentic, differentiated content
3. Lean on Advocates & Community Members to build the above

Rather than spending your budget and resources on chasing ghosts, reallocate it to building experiences that AI can't.


### Post 6
---
"All of our customers know about the community."
...
The days of goosing Active User and Views metrics by @channel-ing us to death is over.

Many uncomfortable conversations with leadership about why the metrics have suddenly dipped lay ahead.


### Post 8
---
The Advocacy programs that struggle to prove ROI never defined the business problem they were solving.

Pick one problem. Define what success looks like. Report on it.
...
### Post 9
---
3 things about the upcoming closure of the Sephora Beauty Insiders Community:

1. My condolences to the faithful members, staff, vendors, and consultants that built it into an incredible place that so many people loved. It's always tough when these decisions are made. Alas, business happens.

2. It was always an outlier. We (Lithium) tried to replicate their success with other retail brands. It never really worked out. That's a testament to Sephora's success and a warning about over indexing on a local maximum.
...
That's the impact on customer accounts with users that are active in community at one of my enterprise B2B SaaS clients over the past year.

Said customers learned the product faster, found quicker time-to-value, and built relationships that are hard to sever. The decision was made long before the renewals rolled around.

The CCO's forecast was more predictable and CSMs were more efficient.
...
+ Advisory Boards
+ Contests & Challenges
+ Small, Private Cohort Groups
+ Exclusive In-Person Events
+ Expert Knowledge Programs

When your products and services homogenize with the same AI features as your competitors, why will prospects pick you?

When your demand gen funnel stops producing because of AEO/GEO, how will you find prospects to fill your pipeline?

When your nearest competitor initiates a race to the bottom on pricing, what tools do you have to retain existing customers?

When AI fatigue hits hard, what makes you a port in the storm?
...
Despite the gloom, all is not lost. Not even close. In fact, we're positioned very well for the AI era.

Here are the themes I picked up on and how to think about them:
...
### Post 14
---
Building "community" in 2026 increasingly means "local meetups"

A decade ago, Holly Firestone, Lauren Uyeno, Tuvy LeLipski, Madeline Johannsen, Catherine Martinez, and Chris Shernaman pioneered scalable, customer-driven local user groups programs that were core to how companies like Salesforce, Atlassian, and Alteryx built legendary communities. They cultivated legions of advocates, powered explosive growth, and built moats that competitors couldn't copy.
...
### Post 15
---
$384k pipeline influence
$62k support cost reduction
$1.2m expansion uplift
$650k attributed retention

What outcomes are your community-driven meetups creating?

We've hit peak virtual event fatigue. AI is eroding authenticity & trust. Your customers are yearning for connection with real people.

In-person events are *so back*

Customer Marketers and Community teams that are focusing on people-first programs that power experiences AI can't are winning. Doubly so when they can show real business impact.
...
### Post 16
---
The flywheel only works if community is connected to the rest of the business.
...
### Post 17
---
Community teams are losing budget battles they should be winning.

The results are there, but they're reporting in a foreign language (active users, posts per week, new members) eliciting more questions than answers...and the path to approval evaporates.

The teams that get more are the ones who make executives feel like community is the obvious investment.

Answer these in every QBR, budget review, and leadership update:

1. What business problem did we solve?
2. What would it have cost to solve it another way?
3. What did it cost us?
4. What's next?

You'll move from "cost center" to "strategic asset."


### Post 18
---
Platform selection is a three-year decision being made in a six-week buying process.

A team sits on demo calls, evaluates feature sets, checks pricing, and picks a vendor in a couple of weeks, then lives with it for a couple of years.
...
+ What if they're acquired, and what does that mean for your contract?

The platform you pick today will still be there in 2029. Buy accordingly.
...
With the right strategy, active participation creates investment. Customers contribute, get answers, build relationships, and feel seen. They stay longer. They expand. They advocate. They refer.

Is your community structured to produce the right outcomes? Can you measure it?
