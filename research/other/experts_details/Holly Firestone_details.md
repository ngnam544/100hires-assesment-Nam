...
Sharing this post on Linkedin because I want to tell this audience two important things:
...
My sweet baby girl Eve is 8 months old tomorrow, and my son Max is officially 2 and a half. I don't know how time moves so quickly and so slow all at once. It's both exciting and terrifying at the same time. The last several months have been immensely valuable, and I'm so grateful I gave myself this gift*.

8 months later, I'm ready. Fully ready to dive into doing the work that I love to do, connect with people over a shared love for building community, and to celebrate all of the successes and wins that come along with that.
...
- Networking hub: Connect with like-minded professionals and expand your professional circle
- Knowledge exchange: Share industry expertise and gain valuable insights from experts in your field
- Exclusive content: Access premium content, webinars, and resources tailored just for our community members

Join us in building a vibrant ecosystem where ideas flourish and thrive. Together, we can elevate our collective success.
...
Pledge 1% is a global movement started by Salesforce and Atlassian that encourages and empowers companies of all sizes and stages to donate 1% of their staff time, product, profit, and/or equity to ANY charity of their choosing. They provide a simple, flexible, and scaleable model to integrate giving back into the DNA of all companies, especially startups. Already thousands of companies around the world have taken the pledge, and dozens of VCs, incubators, and conferences have joined to push the movement forward.

Pledge 1%, believes that all companies have the capacity to give, and they can help map out a timeline and giving plan that aligns with your values and larger business goals. YOU can be a driver of this movement and shift the culture to help companies stand at the forefront of both economic and social change.
...
- Online Trailblazer Community with millions of members
- Global Community User Group program with over 1000 user groups
- Global Trailblazer Community Conference program with 25+ conferences
- Salesforce MVP Program, a program that rewards and recognizes Salesforce's top 1% of Community members for their contributions to the Salesforce community
- Community Operations strategy and execution

Also have the honor of:
- Managing our incredible team of Community Managers and Community Operations Managers
- Speaking at Salesforce Community Conferences around the globe
- Consulting and collaborating with internal Salesforce teams on their own community strategies
...
Salesforce MVP and User Group Programs

Salesforceusergroups.com

http://www.salesforce.com/mvp/
...
- Manage Atlassian User Group Community Program consisting of 120+ User Groups worldwide including recruitment, resources, program feedback, daily moderation, facilitating sponsorships, helping identify key markets, defining metrics, and implementing growth strategy

- Manage Community Platform, including daily maintenance and working with external website developer to create and execute a plan for feature upgrades and bug fixes

- Develop and run the ongoing Dev Den Tech Talks program. Procure innovative and relevant speakers, create marketing plan, execute day of logistics for each event, and conduct post-event analysis
...
- Compose and distribute Community content: newsletters, event marketing emails, community updates, as well as managing and growing social media engagement

- Manage Community intern, guiding and empowering intern to identify goals and the best processes to accomplish them

- Train all members of Community Team on all Community processes and programs

- Responsible for additional Community programs such as Atlassian Seed Program as well as external Community meetup events

- Work with International team Ambassadors to help grow their reach in their markets through Community

- Represent Atlassian globally at conferences, Atlassian User Groups, Community Meetups, Community User Groups, and individual meetings with Community Managers from other companies
...
October 31, 2020, Kendall reported to Holly directly

In short, Holly is the gold star for people managers and team leaders. She sees potential in her team and helps them grow to be their very best version of themselves. While at Salesforce, she guided me both personally and professionally, pivoting when needed even if it meant a change in her priorities. She is trusting, and she knows how to empower someone to do their best and most fulfilling work. She is also a strong listener, advocate, and motivator. I am so grateful I had Holly's leadership early in my career, and that I can continue to have her in my life as a mentor and friend. Thank you Holly!
