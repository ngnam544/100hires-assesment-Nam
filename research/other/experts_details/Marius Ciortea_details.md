...
Grew the IBM developer ecosystem to 450,000+ members, averaging 5,000+ new signups per month across community.ibm.com.

Generated $200M+ in influenced win revenue through developer engagement, advocacy, and digital events.

Directed 400+ annual webinars (75,000+ registrants, 45,000+ attendees), delivering technical enablement and awareness across IBM portfolios.

Produced global TechXchange conferences (5,000+ attendees, up to four times per year) uniting customers, partners, and IBM experts.
...
Established performance metrics and growth frameworks (AAARR model) to track acquisition, activation, and retention.

Frequent industry speaker and recognized thought leader on Developer Relations, Community Strategy, and Ecosystem Design.

Ecosystem Strategy, Developer Relations and +4 skills
...
Director, VMware Developer Relations Program VMware {code}
...
Working directly with the CEO of Contract Live to define the company vision and strategy. We believe that contracts are more than signatures on a paper, they are the start of a trusted relationship between two parties who have made a commitment to success. Contract Live's cloud based solution simplifies the contract process, by providing a single environment to:
- create and manage contract templates
- initiate the contract process with a simple invitation
- history and version control on all changes
- legal and enforceable e-signing
- intuitive archiving
- powerful reporting and search capabilities

Social Media Communications and Customer Experience
...
Content Marketing
-Prioritize and define marketing priorities aligned to executive direction and guidance.
-Managing content calendars that support and extend marketing initiatives, both short- and long-term.
-Developing standards, systems and best practices for content creation, distribution, and duration via 3rd parties, content repurposing, and real-time implementation of content strategies.
...
* Oracle Marketing Mobile strategy owner. The Oracle app (available via iTunes) has over 100k downloads and is quickly becoming the go to content delivery platform for Oracle Customers and Oracle Employees
* Founded Oracle Marketing Lab initiative. Open Space for Oracle Marketing leadership to meet on a weekly basis and explore experimental marketing. Currently the weekly call is attended by more than 50 people. More than 20 projects were originated in this group forum.
* Ownership of the Oracle Community platforms (blogs, wiki and forums) combined over 2 million members. Generating over 2 million page views per month.
* Created http://mix.oracle.com as first enterprise social network for Oracle. 80k active members. Oracle Mix helps Oracle customers and employees connect with each other.
* Leading Oracle Innovation Events Team, focused on customers experience and interaction. Oracle Open World hosts over 40,000 attendees.
...
* Justified and defended projects and provided written, graphic, and verbal information regarding feasibility.
* Developed Oracle pressroom employing semantic Web 2.0 technology http://pressroom.oracle.com/. Press Release views increased by 50%.
* Implemented Oracle Enterprise Secure Search to Oracle.com. 30% increase in traffic to search. 200% increase in search accuracy.
* Launched &quot;OTN Beta&quot;  http://otnsemanticweb.oracle.com/. OTN Beta is a fully dynamic site, based on semantic technology. * Featured by Oracle as an innovative Web 2.0 approach to enterprise Web Sites management.
* Implemented global corporate &quot;Print on Demand&quot; solution for global events kits and marketing collateral. Enabling global Oracle marketing teams to print at low cost/ high quality marketing material globally. Over 2 million in annual savings.
...
* Ensured compliance with timelines and capacity plans, tracked risks and met specifications.
* Improved support response to average 24 hour turnaround for any issue related to Oracle Marketing websites.
* Hired a team of 5 people in India to help provide 24 hour coverage for support and assist with various web productions projects.

Oracle Applications IT
...
* Developed/managed web content for OTN using standard templates and internal proprietary CMS.
...
Working with Marius is a rewarding venture for any professional in sales and marketing.  His brilliance and in marketing is obvious from his resume.  His strategy around business development, the 21st century customer, and quota attainment from the use of social media is well established and first to market.
...
April 27, 2007, Jeff worked with Marius on the same team

Marius, is one of the most motivated and knowledgeable program managers at Oracle that I have came across in my career, with a definite passion for the web. Not only is he great to work with but he was looked up often among peers.
