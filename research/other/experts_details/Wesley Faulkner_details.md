...
With a career rooted in technology and a passion for creating meaningful change, I bring a unique blend of strategic vision and empathy to Developer Relations. My work with companies like AMD, Atlassian, Dell, IBM, and MongoDB has been driven by one goal: to build inclusive, engaged communities that empower both developers and the companies they support.
...
What gets in the way of collaborative, respectful work environments? How can we build teams where everyone can love their work--and working together? Those the questions this podcast explores. Kim Scott, author of Radical Candor and Radical Respect, and Wesley Faulkner, talk about how to translate ideas from the book Radical Respect into on the ground realities on your team. They read short sections of the book and get real about how to disrupt bias, prejudice and bullying before they disrupt your team.
...
Community Pulse is the monthly podcast for community managers and developer evangelists who are looking for information on community building. Community Builders Jason Hand, Mary Thengvall, PJ Hagerty, SJ Morris, and Wesley Faulkner interview experts in the field of Community Leadership and Management on a broad range of topics related to building community.

Community Pulse

Community Pulse is the monthly podcast for community managers and developer evangelists who are looking for information on community building. Community Builders Jason Hand, Mary Thengvall, PJ Hagerty, SJ Morris, and Wesley Faulkner interview experts in the field of Community Leadership and Management on a broad range of topics related to building community.

Team Building, Marketing Strategy and +22 skills
...
- Expanded AWS user group program in North America from 78,000 to over 150,000 members and from 45 to 109 active groups, achieving a 142% increase in groups and a 92% growth in membership over two years.
- Designed and executed targeted community outreach strategies, which contributed to program growth and increased group engagement by over 90%.
- Organized over 50 events, workshops, and webinars, driving a 40% increase in AWS product adoption among attendees and maintaining high post-event satisfaction scores.
- Leveraged community feedback to refine engagement initiatives, resulting in a 15% improvement in member satisfaction scores and increased retention of active group members.

What is Observability? with Liz Fong-Jones | AWS Community Voices
...
Every business is good at something. What is your strength? Your culture? Your customer service? Your product? Your people? The Experience Firm uses your strengths to build an authentic word of mouth marketing experience. Any marketing that doesn't ring true to what your staff and your customers already believe is worthwhile about you, rings false. Do you know what your best and most marketable strengths are?

We're committed to doing things worth talking about. By creating experiential events that combine culture, creative, and customer service, we drive the conversations that deliver business to your front door. Sure, you're going to love us when we're done, but more importantly, your customers are going to love you.
...
- Launched the SingleStore Ambassador program, recruiting over 20 ambassadors in the first year, which boosted brand visibility and engagement across key developer communities.
- Increased engagement across Slack, Reddit, and Twitter by implementing targeted content and interactive campaigns, leading to a 30% growth in community interactions within six months.
- Applied industry-leading community management practices, resulting in increased member retention and higher satisfaction scores among community participants.
- Founded "The Circle," an internal community that united cross-functional teams to develop innovative programs addressing company objectives without allocated headcount, fostering collaboration and resourcefulness to meet strategic goals.
...
Big Tech Q4 Revenues Up, AMD Acquires Xilinx

TWiT After Hours: (not) Match Game Part III

Another exciting (not) Match Game, this time with mystery contestants and celebrity judges Georgia Dow, Wesley Faulkner, Owen JJ Stone, and Mikah Sargent. You can find more about TWiT and subscribe to our full shows at https://shows.twit.tv/...

External Communications, Amazon Web Services (AWS) and +17 skills
...
Conflict Resolution, Community Management and +33 skills
...
Wesley: https://twitter.com/wesley83 Myriam: https://www.youtube.com/user/qrpkgrl We saw a lot at SXSW Interactive. From "Bleed for the Throne", to Blockchai...
...
External Communications, Online Marketing and +24 skills
...
Skills: Team Building, Marketing Strategy, +38 skills
...
Where's Waldo? From March 11-15 you could find him wandering through SXSWi stealing attention. Waldo, in this case, is Namecheap's Wesley Faulkner.

Team Building, Marketing Strategy and +25 skills
...
February 10, 2025, Du'An worked with Wesley but on different teams
...
August 8, 2024, Ben worked with Wesley on the same team
...
I had the pleasure of working with Wesley as a Community Manager at Amazon Web Services (AWS). Their ability to foster engagement and build meaningful connections within our communities was awe-inspiring.

Wesley demonstrated:

1. Exceptional communication skills, adeptly managing conversations across multiple platforms
2. Strong analytical skills, using data to inform decisions and improve community health
...
August 3, 2024, Jenna worked with Wesley on the same team

I have worked with Wesley on various projects and community engagements at AWS over the last two years. Wesley brings his whole, authentic self to work and encourages others to do the same. This authenticity earned trust with the AWS community and made it safer for those on his team to also come as themselves and to speak up. He advocates for the community in every conversation I have with him and challenges our assumptions. He offers his expertise and perspectives on various approaches for helping the community connect both in person and online, how we earn their trust, and how not to lose it. I look forward to working with Wesley again in the future. Any team will be lucky to have him.
...
I have had the distinct pleasure of Wesley's acquaintance for many years, from our first interactions at IBM in IBM Systems, to a few years ago when we both joined AWS. Even before adopting AWS Leadership Principles, such as customer obsession, it was clear to me that he was passionate about customers and their experience. He has built countless relationships with technologists and developers all over the world, creating engaging and compelling content along the way. Wesley is always willing to provide input and advice, and I have appreciated his collaboration and support over the years. He truly is a gem!
...
July 30, 2024, Carol worked with Wesley on the same team

Wesley is a detail-oriented Community Programs Manager adept at delivering outstanding customer experiences. Wesley is truly customer-obsessed, consistently going above and beyond to understand and exceed client needs through his results-driven, pragmatic, and programmatic approach.
...
July 2, 2024, Mark worked with Wesley on the same team
...
June 14, 2024, Bill worked with Wesley but on different teams

Customer (Community?) Obsession is more than a vague leadership principal for Wesley. Every time I've worked with Wesley, he's gone above and beyond to create opportunities for individuals and groups, working overtime to make experiences happen. Wesley recognizes the importance of human connections, and the need to foster relationships with contact and real conversations. Wesley has made all the efforts we've been involved with more successful, thinking out of the box and solving problems on the communities behalf. I'd want him on any team I was a part of.
...
June 12, 2024, Anthony worked with Wesley on the same team

I have the pleasure of working alongside Wesley in the Developer Relations team at AWS. Throughout our time on the team, Wesley consistently demonstrated an exceptional depth of knowledge and a genuine passion for engaging with the developer community.

What sets Wesley apart is his ability to bridge the gap between technical expertise and effective communication. He possesses a remarkable talent for explaining complex concepts in a clear and accessible manner, ensuring that developers of all skill levels can grasp and implement cutting-edge AWS technologies with ease.

Wesley's insights and recommendations have proven invaluable in shaping our team's strategic initiatives. His deep understanding of industry trends and developer needs allows him to anticipate challenges and provide innovative solutions that resonate with developers.

Moreover, Wesley excels at building strong relationships both within AWS and with external partners. His collaborative spirit and diplomatic approach facilitate seamless coordination across teams, ensuring that projects are executed efficiently and with a customer-centric mindset.
